...
public class Punishments {
	...
	public static void appendStarters() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					Config.DATA_LOC + "starters/FirstStarterRecieved.txt"));
			String data = null;
			try {
	...
	public static void appendStarters2() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					Config.DATA_LOC + "starters/SecondStarterRecieved.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
	...
	public static void addIpToStarterList1(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					Config.DATA_LOC + "starters/FirstStarterRecieved.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void unMuteUser(String name) {
		...
		deleteFromFile(Config.DATA_LOC + "bans/UsersMuted.txt", name);
	}
	...
	public static void removeNameFromBanList(String name) {
		...
		deleteFromFile(Config.DATA_LOC + "bans/UsersBanned.txt", name);
	}
	...
	public static void unIPMuteUser(String name) {
		...
		deleteFromFile(Config.DATA_LOC + "bans/IpsMuted.txt", name);
	}
	...
	public static void muteUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					Config.DATA_LOC + "bans/UsersMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedNames.add(data);
	...
	public static void muteIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					Config.DATA_LOC + "bans/IpsMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedIps.add(data);
	...
	public static void banUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					Config.DATA_LOC + "bans/UsersBanned.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
	...
	public static void banIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					Config.DATA_LOC + "bans/IpsBanned.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					addIpToBanList(data);
	...
	public static void unUidBanUser(String name) {
		...
		deleteFromFile(Config.DATA_LOC + "bans/UUIDBans.txt", name);
	}
	...
	public static void banUid() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					Config.DATA_LOC + "bans/UUIDBans.txt"));
			String data;
			try {
				while ((data = in.readLine()) != null) {
	...
	public static void removeUidFromBanList(String UUID) {
		...
		deleteFromFile(Config.DATA_LOC + "bans/UUIDBans.txt", UUID);
	}

	public static void addUidToFile(String UUID) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					Config.DATA_LOC + "bans/UUIDBans.txt", true));
			try {
				out.newLine();
				out.write(UUID);
			} finally {
	...
	public static void addNameToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					Config.DATA_LOC + "bans/UsersBanned.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addUserToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					Config.DATA_LOC + "bans/UsersMuted.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addIpToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					Config.DATA_LOC + "bans/IpsBanned.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addIpToMuteFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					Config.DATA_LOC + "bans/IpsMuted.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
