package wind.model.players.content.music;
...
public class MusicTab {
	...
	public static final MusicTab[] music = {
			...
			new MusicTab("Camelot", 44, 16215, 42),
			new MusicTab("Castlewars", 45, 44212, 43),
	...
	public static void handleClick(Client c, int Id) {
		...
		case 3166:
			...
			case 121168:
				c.soundsOn = false;
				c.getPA().sendFrame36(513, 0);
				c.getPA().sendFrame36(514, 0);
				c.getPA().sendFrame36(515, 0);
				c.getPA().sendFrame36(516, 0);
				break;
				
			case 121172:
				c.soundsOn = true;
				c.getPA().sendFrame36(513, 1);
				c.getPA().sendFrame36(514, 1);
				c.getPA().sendFrame36(515, 0);
				c.getPA().sendFrame36(516, 0);
				break;
			...
			case 121180:
				...
				c.getPA().sendFrame36(514, 0);
				c.getPA().sendFrame36(515, 0);
				c.getPA().sendFrame36(516, 1);
				break;
				/**
				 * End of Sound Effect Volume
				 */
			/**
			 * 	Area Sound Effect Volume
			 */
			case 121184:
				c.soundsOn = false;
				c.getPA().sendFrame36(517, 0);
				c.getPA().sendFrame36(518, 0);
				c.getPA().sendFrame36(519, 0);
				c.getPA().sendFrame36(520, 0);
				break;
				
			case 121188:
				c.soundsOn = true;
				c.getPA().sendFrame36(517, 1);
				c.getPA().sendFrame36(518, 1);
				c.getPA().sendFrame36(519, 0);
				c.getPA().sendFrame36(520, 0);
				break;
			...
			case 74209:// area4
				...
				break;
			/**
			 * End of Area Sound Effect Volume
			 */
