...
public class LunarDiplomacy {
	...
	public static void getDuringInterface(Client c) {
		switch (c.lunarDiplomacy) {
		case 1:
			c.getQuest().clearQuestInterface();
			c.getPA().sendFrame126("Lunar Diplomacy", 8144);
			c.getPA().sendFrame126(
					"The quester told me the lunar people needs help", 8147);
			c.getPA().sendFrame126("with some kind of illness spooking around",
					8148);
			c.getPA().sendFrame126("on the lunar isle, i should go there and",
					8149);
		...
		case 2:
			...
			c.getPA().sendFrame126("Lunar Diplomacy", 8144);
			c.getPA().sendFrame126(
					"@gre@The quester told me the lunar people needs help",
					8147);
			c.getPA().sendFrame126(
					"@gre@with some kind of illness spooking around", 8148);
			c.getPA().sendFrame126(
					"@gre@on the lunar isle, i should go there and", 8149);
			c.getPA().sendFrame126("@gre@talk to Meteora", 8150);
			c.getPA().sendFrame126(
					"I went to the lunar isle and spoke to Meteora", 8151);
			c.getPA().sendFrame126(
					"she told the about the issue they are having", 8152);
			c.getPA().sendFrame126("and i accepted to help them!", 8153);
			c.getPA().sendFrame126("she want me to get her villains medicine",
					8154);
			c.getPA().sendFrame126("from the chemist in @or1@Draynor Village",
					8155);
			c.getPA().showInterface(8134);
			break;
		...
		case 3:
			...
			c.getPA().sendFrame126("@gre@talk to Meteora", 8150);
			c.getPA().sendFrame126(
					"@gre@I went to the lunar isle and spoke to Meteora", 8151);
			c.getPA().sendFrame126(
					"@gre@she told the about the issue they are having", 8152);
			c.getPA().sendFrame126("@gre@and i accepted to help them!", 8153);
			c.getPA().sendFrame126(
					"@gre@she want me to get her villains medicine", 8154);
			c.getPA().sendFrame126(
					"@gre@from the Chemist in @or1@Draynor Village", 8155);
			c.getPA().sendFrame126(
					"I've asked the Chemist to brew a medicine for me", 8156);
			c.getPA().sendFrame126(
					"And he kindly accepted if i brought him the ingredients",
					8157);
		...
		case 4:
			...
			c.getPA().sendFrame126(
					"@gre@from the Chemist in @or1@Draynor Village", 8155);
			c.getPA().sendFrame126(
					"@gre@I've asked the Chemist to brew a medicine for me",
					8156);
			c.getPA()
					.sendFrame126(
							"@gre@And he kindly accepted if i brought him the ingredients",
							8157);
			c.getPA().sendFrame126(
					"The Chemist created a medicine for me when i brought",
					8158);
			c.getPA().sendFrame126(
					"him the required ingredients, now i should", 8159);
		...
		case 5:
			...
			c.getPA()
					.sendFrame126(
							"@gre@The Chemist created a medicine for me when i brought",
							8158);
			c.getPA().sendFrame126(
					"@gre@him the required ingredients, now i should", 8159);
			c.getPA().sendFrame126("@gre@take this potion back to Meteora!",
					8160);
			c.getPA()
					.sendFrame126(
							"I gave the potion to Meteora, i should speak to here again!",
							8161);
			c.getPA().showInterface(8134);
			break;
		case 6:
			...
			c.getPA()
					.sendFrame126(
							"@gre@ gave the potion to Meteora, i should speak to here again!",
							8161);
			c.getPA().sendFrame126(
					"Meteora used the medicine for all her villains and they",
					8162);
			c.getPA()
					.sendFrame126(
							"Are now cured, but she needed help with the cause of this.",
							8163);
			c.getPA()
					.sendFrame126(
							"I should talk to the adventurer in the <col=255>Chaos Dungeon</col>",
							8164);
			c.getPA().showInterface(8134);
			break;
		case 7:
		...
		case 8:
			...
			c.getPA()
					.sendFrame126(
							"@gre@Meteora used the medicine for all her villains and they",
							8162);
			c.getPA()
					.sendFrame126(
							"@gre@Are now cured, but she needed help with the cause of this.",
							8163);
			c.getPA()
					.sendFrame126(
							"@gre@I should talk to the adventurer in the <col=255>Chaos Dungeon</col>",
							8164);
			c.getPA().sendFrame126("I have killed bork, i should tell Meteora",
					8165);
			c.getPA().showInterface(8134);
			break;
		}
	...
	public static void startInt(Client c) {
		c.getQuest().clearQuestInterface();
		c.getPA().sendFrame126("Lunar Diplomacy", 8144);
		c.getPA().sendFrame126(
		...
		c.getPA()
				.sendFrame126(
						"You can find him behind the general store in edgeville.",
						8148);
	...
	public static void endInt(Client c) {
		c.getQuest().clearQuestInterface();
		// c.getPA().sendFrame126("Lunar Diplomacy", 8144);
		...
		c.getPA().sendFrame126("And the ability to use the Lunar spellbook.",
				8151);
		c.getPA().showInterface(8134);
	}
}