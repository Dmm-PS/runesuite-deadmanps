...
public class DesertTreasure {
	...
	public static void getDuringInterface(Client c) {
		...
		case 1:
			...
			c.getPA().sendFrame126("The quester told me an archaeologist was",
					8147);
			c.getPA()
					.sendFrame126("seeking for help about lost diamonds", 8148);
			c.getPA().sendFrame126(
					"i should go find and talk to him about that", 8149);
			c.getPA().sendFrame126(
					"Quester said he was located ontop of @or1@wolfs mountain",
					8150);
		...
		case 2:
			c.getQuest().clearQuestInterface();
			c.getPA().sendFrame126("Desert Treasure", 8144);
			c.getPA().sendFrame126("I've killed 1 of the 4 bosses for him!",
					8147);
		...
		case 3:
			c.getQuest().clearQuestInterface();
			c.getPA().sendFrame126("Desert Treasure", 8144);
			c.getPA().sendFrame126("I've killed 2 of the 4 bosses for him!",
					8147);
			c.getPA().sendFrame126("And i got the diamond from it.", 8148);
			c.getPA().sendFrame126("I should speak to him again.", 8149);
			c.getPA().showInterface(8134);
		...
		case 4:
			c.getQuest().clearQuestInterface();
			c.getPA().sendFrame126("Desert Treasure", 8144);
			c.getPA().sendFrame126("I've killed 3 of the 4 bosses for him!",
					8147);
			c.getPA().sendFrame126("And i got the diamond from it.", 8148);
			c.getPA().sendFrame126("I should speak to him again.", 8149);
			c.getPA().showInterface(8134);
		...
		case 5:
			c.getQuest().clearQuestInterface();
			c.getPA().sendFrame126("Desert Treasure", 8144);
			c.getPA().sendFrame126("I've killed 4 of the 4 bosses for him!",
					8147);
			c.getPA().sendFrame126("And i got the diamond from it.", 8148);
			c.getPA().sendFrame126("I should speak to him again.", 8149);
			c.getPA().showInterface(8134);
	...
	public static void startInt(Client c) {
		...
		c.getPA().sendFrame126(
				...
				8147);
		c.getPA().sendFrame126("You can find him behind the general store.",
				8148);
		...
		c.getPA()
				.sendFrame126("And being able to kill High level bosses", 8155);
		c.getPA().showInterface(8134);
	}
	...
	public static void endInt(Client c) {
		...
		c.getPA().sendFrame126("And the ability to use the Ancient spellbook.",
				8151);
		c.getPA().showInterface(8134);
	}
}