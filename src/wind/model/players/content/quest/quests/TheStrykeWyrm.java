	...
	public static void getDuringInterface(Client c) {
		...
		case 1:
			...
			c.getPA().sendFrame126(
					"The quester told me people were having problems", 8147);
			c.getPA().sendFrame126(
					"with strykeworms that are invading various locations",
					8148);
			c.getPA().sendFrame126(
					"Such as the jungle, desert and snowy areas", 8149);
		...
		case 2:
			...
			c.getPA().sendFrame126("The Strykewyrm", 8144);
			c.getPA().sendFrame126(
					"@gre@The quester told me people were having problems",
					8147);
			c.getPA()
					.sendFrame126(
							"@gre@with strykeworms that are invading various locations",
							8148);
			c.getPA().sendFrame126(
					"@gre@Such as the jungle, desert and snowy areas", 8149);
			c.getPA().sendFrame126("@gre@I should have a look at one!", 8150);
			c.getPA().sendFrame126("I have located the strykeworm", 8151);
			c.getPA().sendFrame126(
					"I should go back and hear what quester has to say", 8152);
			c.getPA().showInterface(8134);
			break;
		}
	}
