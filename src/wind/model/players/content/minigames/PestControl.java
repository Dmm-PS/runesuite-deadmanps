...
public class PestControl {
	...
	private int[][] pcNPCData = { { 6142, 2629, 2592 }, // portal
			{ 6143, 2681, 2589 }, // portal
			{ 6144, 2670, 2571 }, // portal
			{ 6145, 2646, 2570 }, // portal
	...
	private int[][] voidMonsterData2 = {
			{ shifter, 2660 + Misc.random(8), 2592 + Misc.random(8) },
			{ brawler, 2663 + Misc.random(8), 2575 + Misc.random(8) },
			{ defiler, 2656 + Misc.random(8), 2572 + Misc.random(8) },
			{ ravager, 2664 + Misc.random(8), 2574 + Misc.random(8) },
			{ torcher, 2656 + Misc.random(8), 2595 + Misc.random(8) },
			{ ravager, 2634 + Misc.random(8), 2596 + Misc.random(8) },
			{ brawler, 2638 + Misc.random(8), 2588 + Misc.random(8) },
			{ shifter, 2637 + Misc.random(8), 2598 + Misc.random(8) },
			{ ravager, 2677 + Misc.random(8), 2579 + Misc.random(8) },
			{ defiler, 2673 + Misc.random(8), 2584 + Misc.random(8) },
			{ defiler, 2673 + Misc.random(8), 2584 + Misc.random(8) },
			{ defiler, 2675 + Misc.random(8), 2591 + Misc.random(8) } };
	...
	private void startGame() {
		...
		TaskHandler.submit(new Task(15, false) {			
			@Override
			public void execute() {
				if (gameTimer == 0 || KNIGHTS_HEALTH == 0 || !gameStarted) {
					this.cancel();
				}
				if (gameTimer == 300 || KNIGHTS_HEALTH == 175) {
					spawnNPC2();	
				}
				if (gameTimer == 200 || KNIGHTS_HEALTH == 125) {
					spawnNPC2();
				}				
				if (gameTimer == 100 || KNIGHTS_HEALTH == 75) {
					spawnNPC2();
				}
			}
			@Override
		...
		for (Client player : waitingBoat.keySet()) {
			...
			player.getPA().movePlayer(2656 + Misc.random(3),
					2614 - Misc.random(4), 0);
	...
	private void spawnNPC3() {
		for (int[] voidMonsters2 : voidMonsterData2) {
			NPCHandler.spawnNpc2(voidMonsters2[0], voidMonsters2[1],
					voidMonsters2[2], 0, 1, 500, 20, 200, 25);
		}
	}
