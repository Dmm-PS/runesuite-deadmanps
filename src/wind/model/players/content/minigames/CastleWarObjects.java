...
public class CastleWarObjects {
	...
	public static boolean handleObject(final Client c, final int id,
		...
		case 4432:
			...
			TaskHandler.submit(new Task(4, true) {
		...
		case 4448: // collapse tunnel
			...
			if (x >= 2390 && x <= 2393 && y >= 9500 && y <= 9503
					&& CastleWars.saraRock1 || x >= 2399 && x <= 2402
					&& y >= 9511 && y <= 9514 && CastleWars.saraRock2
					|| x >= 2408 && x <= 2411 && y >= 9502 && y <= 9505
					&& CastleWars.zammyRock1 || x >= 2400 && x <= 2403
					&& y >= 9493 && y <= 9496 && CastleWars.zammyRock2) {
		...
		case 4437: // mine through tunnel
			...
			if (x == 2391 && y == 9501 && !CastleWars.saraRock1 || x == 2400
					&& y == 9512 && !CastleWars.saraRock2 || x == 2409
					&& y == 9503 && !CastleWars.zammyRock1 || x == 2401
					&& y == 9494 && !CastleWars.zammyRock2) {
			...
			TaskHandler.submit(new Task(10, true) {
				...
				@Override
				public void execute() {
					if (x == 2391 && y == 9501 && !CastleWars.saraRock1
							|| x == 2400 && y == 9512 && !CastleWars.saraRock2
							|| x == 2409 && y == 9503 && !CastleWars.zammyRock1
							|| x == 2401 && y == 9494 && !CastleWars.zammyRock2) {
						c.sendMessage("This rock has already been mined.");
						this.cancel();
						return;
					}
		...
		case 4900: // Sara flag ground object
			 ...
			 * return true; } if ((CastleWars.getTeamNumber(c) == 1)) {
			 * CastleWars.returnFlag(c, 4037); } else if
			 * ((CastleWars.getTeamNumber(c) == 1) ||
			 * (CastleWars.getTeamNumber(c) == 2)) { CastleWars.captureFlag(c);
			 * }
			 */
		...
		case 4901: // Zammy flag ground object
			 ...
			 * { return true; } if ((CastleWars.getTeamNumber(c) == 2)) {
			 * CastleWars.returnFlag(c, 4039); } else if
			 * ((CastleWars.getTeamNumber(c) == 1) ||
			 * (CastleWars.getTeamNumber(c) == 2)) { CastleWars.captureFlag(c);
			 * }
			 */
		...
		case 4381:
			int[][] sDamageArea = { { 2417, 3103 }, { 2409, 3093 },
					{ 2402, 3086 }, { 2397, 3079 }, { 2420, 3096 } };
			if (!(CastleWars.getTeamNumber(c) == 2)) {
			...
			c.getPA().createPlayersStillGfx(287, sDamageArea[p][0],
					sDamageArea[p][1], 0, 1);
	...
	public static void castleWarsFlags(Client c, int team) {
		if (team == 1) {
			if ((CastleWars.saraFlag == 2)) {
				new Object(4900, c.getX(), c.getY(), c.heightLevel, -3, 10,
						4900, -1, 1);
				// Server.objectHandler.createAnObject(c, 4900, c.getX(),
				// c.getY(), c.heightLevel, -3, 10);
			} else {
				new Object(-1, c.getX(), c.getY(), c.heightLevel, -3, 10, -1,
						-1, 1);
				// Server.objectHandler.createAnObject(c, -1, c.getX(),
				// c.getY(), c.heightLevel, -3, 10);
			}
			if ((CastleWars.saraFlag == 1) || (CastleWars.saraFlag == 2)) {
				new Object(4377, 2429, 3074, 3, -3, 10, 4377, -1, 1);
				// Server.objectHandler.createAnObject(c, 4377, 2429, 3074, 3,
				// -3, 10);
			} else {
				new Object(4902, 2429, 3074, 3, -3, 10, 4902, -1, 1);
				// Server.objectHandler.createAnObject(c, 4902, 2429, 3074, 3,
				// -3, 10);
			}
		} else if (team == 2) {
			if (CastleWars.zammyFlag == 2) {
				new Object(4901, c.getX(), c.getY(), c.heightLevel, -1, 10,
						4901, -1, 1);
			} else {
				new Object(-1, c.getX(), c.getY(), c.heightLevel, -1, 10, -1,
						-1, 1);
			}
			if (CastleWars.zammyFlag == 1 || CastleWars.zammyFlag == 2) {
	...
	public static void castleWarsRocks(Client c, int team) {
		/*
		 * if (!c.inCwUnderground()) { return; }
		 */
		if (team == 1) {
			if (!CastleWars.saraRock1) {
				new Object(4439, 2391, 9501, 0, 0, 10, 4439, -1, 1);
				// Server.objectHandler.createAnObject(c, 4439, 2391, 9501, 0,
				// 0, 10);
			} else {
				new Object(4437, 2391, 9501, 0, 0, 10, 4437, -1, 1);
				// Server.objectHandler.createAnObject(c, 4437, 2391, 9501, 0,
				// 0, 10);
			}
			if (!CastleWars.saraRock2) {
				new Object(4439, 2400, 9512, 0, 0, 10, 4439, -1, 1);
				// Server.objectHandler.createAnObject(c, 4439, 2400, 9512, 0,
				// 0, 10);
			} else {
				new Object(4437, 2400, 9512, 0, 0, 10, 4437, -1, 1);
				// Server.objectHandler.createAnObject(c, 4437, 2400, 9512, 0,
				// 0, 10);
			}
		} else if (team == 2) {
			if (!CastleWars.zammyRock1) {
				new Object(4439, 2409, 9503, 0, 0, 10, 4439, -1, 1);
				// Server.objectHandler.createAnObject(c, 4439, 2409, 9503, 0,
				// 0, 10);
			} else {
				new Object(4437, 2409, 9503, 0, 0, 10, 4437, -1, 1);
				// Server.objectHandler.createAnObject(c, 4437, 2409, 9503, 0,
				// 0, 10);
			}
			if (!CastleWars.zammyRock2) {
				new Object(4439, 2401, 9494, 0, 0, 10, 4439, -1, 1);
				// Server.objectHandler.createAnObject(c, 4439, 2401, 9494, 0,
				// 0, 10);
			} else {
				new Object(4437, 2401, 9494, 0, 0, 10, 4437, -1, 1);
				// Server.objectHandler.createAnObject(c, 4437, 2401, 9494, 0,
				// 0, 10);
			}
		}
	}
	...
	public static void castleWarsCatapults(Client c, int team) {
		...
		if (team == 1) {
			if (!CastleWars.saraCatapult) {
				...
				// Server.objectHandler.createAnObject(c, 4386, 2413, 3088, 0,
				// 0, 10);
			} else {
				new Object(4382, 2413, 3088, 0, 0, 10, 4382, -1, 1);
				// Server.objectHandler.createAnObject(c, 4382, 2413, 3088, 0,
				// 0, 10);
			}
		} else if (team == 2) {
			if (!CastleWars.zammyCatapult) {
				new Object(4385, 2384, 3117, 0, -2, 10, 4385, -1, 1);
				// Server.objectHandler.createAnObject(c, 4385, 2384, 3117, 0,
				// -2, 10);
			} else {
				new Object(4381, 2384, 3117, 0, -2, 10, 4381, -1, 1);
				// Server.objectHandler.createAnObject(c, 4381, 2384, 3117, 0,
				// -2, 10);
			}
		}
	}
	...
	public static void castleWarsDoors(Client c, int team) {
		...
		if (team == 1) { // 1 = north, 2 = east, 3 = south, 4/0 = west
			if (CastleWars.saraSideDoor) {
				...
				// Server.objectHandler.createAnObject(c, 4466, 2414, 3073, 0,
				// 1, 0);
				// Server.objectHandler.createAnObject(c, -1, 2415, 3073, 0, 0,
				// 0);
			} else {
				new Object(4465, 2415, 3073, 0, 0, 0, 4465, -1, 1);
				new Object(-1, 2414, 3073, 0, 0, 0, -1, -1, 1);
				// Server.objectHandler.createAnObject(c, 4465, 2415, 3073, 0,
				// 0, 0);
				// Server.objectHandler.createAnObject(c, -1, 2414, 3073, 0, 0,
				// 0);
			}
			if (CastleWars.saraMainDoor == 1) {
				...
				// Server.objectHandler.createAnObject(c, 4423, 2426, 3088, 0,
				// 3, 0);
				// Server.objectHandler.createAnObject(c, 4424, 2427, 3088, 0,
				// 3, 0);
				// Server.objectHandler.createAnObject(c, -1, 2426, 3087, 0, 0,
				// 0);
				// Server.objectHandler.createAnObject(c, -1, 2427, 3087, 0, 0,
				// 0);
			} else {
				new Object(CastleWars.saraMainDoor == 2 ? 4425 : 4432, 2426,
						3087, 0, 0, 0, CastleWars.saraMainDoor == 2 ? 4425
								: 4432, -1, 1);
				new Object(CastleWars.saraMainDoor == 2 ? 4426 : 4431, 2427,
						3087, 0, 2, 0, CastleWars.saraMainDoor == 2 ? 4426
								: 4431, -1, 1);
				new Object(-1, 2426, 3088, 0, 3, 0, -1, -1, 1);
				new Object(-1, 2427, 3088, 0, 3, 0, -1, -1, 1);
				// Server.objectHandler.createAnObject(c,
				// CastleWars.saraMainDoor == 2 ? 4425 : 4432, 2426, 3087, 0, 0,
				// 0);
				// Server.objectHandler.createAnObject(c,
				// CastleWars.saraMainDoor == 2 ? 4426 : 4431, 2427, 3087, 0, 2,
				// 0);
				// Server.objectHandler.createAnObject(c, -1, 2426, 3088, 0, 3,
				// 0);
				// Server.objectHandler.createAnObject(c, -1, 2427, 3088, 0, 3,
				// 0);
			}
		} else if (team == 2) {
			if (CastleWars.zammySideDoor) {
				...
				// Server.objectHandler.createAnObject(c, 4468, 2385, 3134, 0,
				// 3, 0);
				// Server.objectHandler.createAnObject(c, -1, 2384, 3134, 0, 2,
				// 0);
			} else {
				new Object(4467, 2384, 3134, 0, 2, 0, 4467, -1, 1);
				new Object(-1, 2385, 3134, 0, 0, 0, -1, -1, 1);
				// Server.objectHandler.createAnObject(c, 4467, 2384, 3134, 0,
				// 2, 0);
				// Server.objectHandler.createAnObject(c, -1, 2385, 3134, 0, 0,
				// 0);
			}
			if (CastleWars.zammyMainDoor == 1) {
				...
				// Server.objectHandler.createAnObject(c, 4427, 2373, 3119, 0,
				// 1, 0);
				// Server.objectHandler.createAnObject(c, 4428, 2372, 3119, 0,
				// 1, 0);
				// Server.objectHandler.createAnObject(c, -1, 2373, 3120, 0, 0,
				// 0);
				// Server.objectHandler.createAnObject(c, -1, 2372, 3120, 0, 0,
				// 0);
			} else {
				new Object(CastleWars.zammyMainDoor == 2 ? 4429 : 4433, 2373,
						3120, 0, 2, 0, CastleWars.zammyMainDoor == 2 ? 4429
								: 4433, -1, 1);
				new Object(CastleWars.zammyMainDoor == 2 ? 4430 : 4434, 2372,
						3120, 0, 0, 0, CastleWars.zammyMainDoor == 2 ? 4430
								: 4434, -1, 1);
				new Object(-1, 2373, 3119, 0, 1, 0, -1, -1, 1);
				new Object(-1, 2372, 3119, 0, 2, 0, -1, -1, 1);
				// Server.objectHandler.createAnObject(c,
				// CastleWars.zammyMainDoor == 2 ? 4429 : 4433, 2373, 3120, 0,
				// 2, 0);
				// Server.objectHandler.createAnObject(c,
				// CastleWars.zammyMainDoor == 2 ? 4430 : 4434, 2372, 3120, 0,
				// 0, 0);
				// Server.objectHandler.createAnObject(c, -1, 2373, 3119, 0, 1,
				// 0);
				// Server.objectHandler.createAnObject(c, -1, 2372, 3119, 0, 2,
				// 0);
			}
		}
	}
	...
	public void reloadCastleWarsObjects() {
		for (int d = 0; d < Config.MAX_PLAYERS; d++) {
			if (PlayerHandler.players[d] != null
					&& PlayerHandler.players[d].isActive) {
