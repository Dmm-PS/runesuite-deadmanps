...
/**
 * @author Fuzen Seth
 * @information Represents a proper equipment class.
 * @Since 23.7.2014
 */
public class Equipment {
	...
	public boolean isWearingAntiFire(Client c) {
	 ...
	 */
	public boolean isWearingDharoks(Client c) {
	 ...
	 */
	public boolean isWearingVeracs(Client c) {
		if ((c.playerEquipment != null) 
	 ...
	 */
	public boolean isWearingGuthans(Client c) {
		if ((c.playerEquipment != null) 
