...
public class ClanManager {
	...
	public int getTotalClans() {
		File localFile = new File(Config.DATA_LOC + "/clan/");
	...
	public void create(Client paramClient) {
		...
		paramClient
				.sendMessage("@red@You may change your clan settings by clicking the 'Clan Setup' button.");
	}
	...
	private Clan read(String paramString) {
		File localFile = new File(Config.DATA_LOC + "/clan/" + paramString
				+ ".cla");
		if (!localFile.exists()) {
			return null;
		}
