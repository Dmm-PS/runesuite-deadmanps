...
public class Region {
	...
	public static void load() {
		try {
			File f = new File(Config.DATA_LOC + "world/map_index");
			...
			for (int i = 0; i < size; i++) {
				byte[] file1 = getBuffer(new File(Config.DATA_LOC + "world/map/"
						+ mapObjectsFileIds[i] + ".gz"));
				byte[] file2 = getBuffer(new File(Config.DATA_LOC + "world/map/"
