...
public class ControlPanel extends JFrame {
	...
	public void initComponents() {
		...
		RESTART_SERVER.setText("Restart");
		RESTART_SERVER.setToolTipText("Restarts the server.");
		RESTART_SERVER.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				ActionPerformed(evt);
			}
		});
		...
		CONTROL_TABS.addTab("Remote", SERVER_REMOTE_TAB);
		ENTITY_LIST.setBorder(BorderFactory
				.createLineBorder(new java.awt.Color(0, 0, 0)));
		ENTITY_LIST.setForeground(new java.awt.Color(51, 0, 0));

		GroupLayout layout = new GroupLayout(getContentPane());

		CONTROL_TABS.addTab("Punishments", SERVER_PUNISHMENTS);
		ENTITY_LIST.setBorder(BorderFactory
				.createLineBorder(new java.awt.Color(0, 0, 0)));
		ENTITY_LIST.setForeground(new java.awt.Color(51, 0, 0));
								...
								.addGroup(
										layout.createParallelGroup(
												...
												.addComponent(
														...
														280, Short.MAX_VALUE))
								.addContainerGap()));
		Image icon = getImage("mapicon.png");
		if (icon != null)
	...
	private Image getImage(String name) {
		...
		try {
			File f = new File(Config.DATA_LOC + name);
			if (f.exists())
	...
	public DefaultListModel<String> LIST_NPCS;
	public JMenuItem EXIT_ITEM;
	public JMenu FILE_MENU;
	public JButton FORCE_CHAT;
	public JButton RESTART_SERVER;
	public JList<String> FORCE_COMMANDS;
	...
	public JComboBox<String> MESSAGE_ALL_BOX;
	public JComboBox<String> MESSAGE_ALL_COLOR_BOX;
	...
	public JList<String> NPC_OPTION_LIST;
	...
	public JPanel SERVER_REMOTE_TAB;
	public JPanel SERVER_PUNISHMENTS;
	...
	public JList<String> TELEPORT_LIST;
